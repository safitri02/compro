...
$id= $_GET["id_jurusan"];
$data= mysqli_query($koneksi, "SELECT * FROM tb_jurusan WHERE id_jurusan= $id ");
                      ...
                      <div class="card-body">
                        ...
                        <form class="forms-sample" action="" method="post">
                          <div class="form-group">
                            ...
                            value="<?= $a["kode_jurusan"]; ?>" autocomplete="off" required value="">
                          </div>
                          <div class="form-group">
                            <label for="jurusan">Masukkan Jurusan</label>
                            <input type="text" class="form-control" id="jurusan" name="jurusan" placeholder="Masukan Jurusan Baru" autocomplete="off" required value="<?= $a["jurusan"]; ?>">
                          </div>
                          <button type="submit" class="btn btn-success mr-2" name="simpan">Simpan Jurusan</button>
                        </form>
                      </div>
                    </div>
                  </div>
